...
const ProductDetails = () => {
  ...
  const raletedProducts = products.filter(item => item.category === category)
  ...
  return <Helmet title={productName}>
    ...
    <section className='product__main pt-0'>
      <Container>
        <Row>
          <Col lg='6'>
            <img src={imgUrl} alt="" />
          ...
          <Col lg='6'>
            ...
            <div className="product__details">
              ...
              gap-5 mb-3">
                <div><span><i class="ri-star-s-fill"></i></span>
    ...
    <section>
      <Container>
        <Row>
          <Col lg='12'>
            ...
            {tab === 'desc' ? (<div className='tab__content mt-5'>
              ...
              <div className="review__wrapper">
                <ul>
                  {
                    reviews?.map((item, index) => (<li key={index} className='mb-4'>
          ...
          <ProductsList data={raletedProducts} />
        </Row>
      </Container>
    </section>
  </Helmet>
